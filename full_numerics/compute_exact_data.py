...
for V0 in V0_tqi:
    ...
    # q(r) = beta0 * t(r) / 4, consistent with paper's HDA remainder formulas
...
model_v = TwoStateExactModel(N=N, t0=t0, V0=V0_verify, n_core=n_core,
                               beta0=beta0, cstar_sq=cstar_sq)
pref_v = model_v.beta0 / model_v.cstar_sq
rho_sigma_v = model_v.rho_sigma(Phi_v)
rho_tgt_v = model_v.rho_tgt_smeared(Phi_v)
